...
class BannerRepository:
    @staticmethod
    async def get_user_banner(session, banner_options: SUserBannerGet, is_admin) -> SUserBanner:
        query = (
            select(BannersOrm)
    ...
    @staticmethod
    async def add_banner(session, data: SBannerAdd):
        query = (
            select(BannersOrm)
    ...
    @staticmethod
    async def get_banners(session, banner_options) -> list[SBanner]:
    ...
    @staticmethod
    async def patch_banner(session, id: int, patch_banner: SBannerPatch):
    ...
    @ staticmethod
    async def delete_banner(session, id: int):
